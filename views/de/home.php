      ...
      <form id="contact-form" class="contact-form" action="<?= htmlspecialchars($action, ENT_QUOTES, 'UTF-8') ?>" method="post" novalidate>
        ...
        <div class="form-row">
          <div class="checkbox-row">
            ...
            />
            <label for="consent">
              Ich habe die <a href="/datenschutz" target="_blank" rel="noopener noreferrer">Datenschutzerklärung</a> gelesen und bin einverstanden,
              dass meine Angaben zur Beantwortung meiner Anfrage verarbeitet werden.
              <span class="req">*</span>
            </label>
          </div>
          ...
          <?php endif; ?>
          <p class="form-hint">
            DSGVO-Hinweis: Es werden nur die von dir angegebenen Daten verarbeitet, um deine Anfrage zu beantworten. Keine Weitergabe an Dritte.
          </p>
        </div>
